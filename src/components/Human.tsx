...
export default function Human({ label, heading, body }: HumanProps) {
  return (
    <section id="human" data-testid="humanSection" className="py-14 sm:py-22 border-b border-border" style={{ background: "var(--petrol-dim)" }}>
      <div className="max-w-[920px] mx-auto px-5 sm:px-10">
        <RevealSection>
          ...
          <h2 data-testid="humanHeading" className="font-display text-[1.9rem] sm:text-[2.25rem] leading-[1.12] tracking-[-0.015em] text-text-1 mb-8 sm:mb-10">
            {heading}
          </h2>
