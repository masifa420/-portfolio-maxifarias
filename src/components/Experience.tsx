...
export default function Experience({
  ...
  return (
    <section id="experience" data-testid="experienceSection" className="py-14 sm:py-22 border-b border-border" style={{ background: "var(--petrol-dim)" }}>
      <div className="max-w-[920px] mx-auto px-5 sm:px-10">
        <RevealSection>
          ...
          <h2 data-testid="experienceHeading" className="font-display text-[1.9rem] sm:text-[2.25rem] leading-[1.12] tracking-[-0.015em] text-text-1 mb-8 sm:mb-11">
            {heading}
          </h2>
          ...
          <div className="flex flex-col gap-12">
            {experience.map((job, i) => (
              ...
              >
                ...
                <div>
                  <h3 data-testid={`experienceCompany${i}`} className="font-display text-[1.55rem] text-text-1 leading-[1.15] mb-[0.3rem]">
                    {company}
                  </h3>
